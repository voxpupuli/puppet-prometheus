...
# @param config_input
#  Structured, hash of grok exporter input definition
# @param config_metrics
#  Structured, array of hash of grok exporter metric definition
class prometheus::grok_exporter (
  Hash $config_input,
  Array[Hash] $config_metrics,
  ...
  file { $config_file:
    ...
    group   => $group,
    mode    => $config_mode,
    content => template('prometheus/grok_exporter.yaml.erb'),
