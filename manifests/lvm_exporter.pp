# @summary This module manages prometheus lvm_exporter
# @param arch
...
class prometheus::lvm_exporter (
  String $download_extension = 'tar.gz',
  Prometheus::Uri $download_url_base = 'https://github.com/hansmi/prometheus-lvm-exporter/releases',
  Array[String] $extra_groups = [],
  String[1] $group = 'lvm-exporter',
  String[1] $package_ensure = 'latest',
  String[1] $package_name = 'prometheus-lvm-exporter',
  String[1] $user = 'lvm-exporter',
  # renovate: depName=hansmi/prometheus-lvm-exporter
  String[1] $version                                         = '0.6.2',
  Boolean $purge_config_dir                                  = true,
  Boolean $restart_on_change                                 = true,
  Boolean $service_enable                                    = true,
  Stdlib::Ensure::Service $service_ensure                    = 'running',
  String[1] $service_name                                    = 'lvm_exporter',
  ...
  Stdlib::Absolutepath $archive_bin_path                     = "/opt/${package_name}_${version}_${os}_${arch}/${package_name}",
  Optional[Stdlib::Host] $scrape_host                        = undef,
  Boolean $export_scrape_job                                 = false,
  Stdlib::Port $scrape_port                                  = 9845,
  String[1] $scrape_job_name                                 = 'lvm',
