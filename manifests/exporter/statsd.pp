...
class prometheus::exporter::statsd (
  ...
  $options = "${option_prefix}statsd.mapping-config=\'${prometheus::exporter::statsd::mapping_config_path}\' ${prometheus::exporter::statsd::extra_options}"
