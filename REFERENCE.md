...
* [`prometheus::exporter::apache`](#prometheusexporterapache): This module manages prometheus apache_exporter
* [`prometheus::exporter::beanstalkd`](#prometheusexporterbeanstalkd): This module manages prometheus beanstalkd_exporter
* [`prometheus::exporter::bind`](#prometheusexporterbind): Class: prometheus::exporter::bind  This module manages prometheus bind_exporter
* [`prometheus::exporter::bird`](#prometheusexporterbird): This module manages prometheus bird exporter
* [`prometheus::exporter::blackbox`](#prometheusexporterblackbox): This module manages prometheus blackbox_exporter
* [`prometheus::exporter::collectd`](#prometheusexportercollectd): This module manages prometheus node collectd_exporter
* [`prometheus::exporter::consul`](#prometheusexporterconsul): This module manages prometheus node consul_exporter
* [`prometheus::exporter::dellhw`](#prometheusexporterdellhw): This module manages prometheus node dellhw_exporter
* [`prometheus::exporter::elasticsearch`](#prometheusexporterelasticsearch): This module manages prometheus elasticsearch_exporter
* [`prometheus::exporter::graphite`](#prometheusexportergraphite): This module manages prometheus node graphite_exporter
* [`prometheus::exporter::grok`](#prometheusexportergrok): This module manages prometheus grok_exporter
* [`prometheus::exporter::haproxy`](#prometheusexporterhaproxy): This module manages prometheus haproxy_exporter
* [`prometheus::exporter::memcached`](#prometheusexportermemcached): This module manages prometheus node memcached_exporter
* [`prometheus::exporter::mesos`](#prometheusexportermesos): This module manages prometheus mesos_exporter
* [`prometheus::exporter::mongodb`](#prometheusexportermongodb): This module manages prometheus mongodb_exporter
* [`prometheus::exporter::mysqld`](#prometheusexportermysqld): manages prometheus mysqld_exporter
* [`prometheus::exporter::nginx_vts`](#prometheusexporternginx_vts): This module manages prometheus nginx_vts_exporter
* [`prometheus::exporter::node`](#prometheusexporternode): This module manages prometheus node node_exporter
* [`prometheus::exporter::postfix`](#prometheusexporterpostfix): manages prometheus postfix_exporter
* [`prometheus::exporter::postgres`](#prometheusexporterpostgres): This module manages prometheus node postgres_exporter
* [`prometheus::exporter::process`](#prometheusexporterprocess): This module manages prometheus process_exporter
* [`prometheus::exporter::puppetdb`](#prometheusexporterpuppetdb): This module manages prometheus node puppetdb_exporter
* [`prometheus::exporter::rabbitmq`](#prometheusexporterrabbitmq): This module manages prometheus rabbitmq_exporter
* [`prometheus::exporter::redis`](#prometheusexporterredis): This module manages prometheus node redis_exporter
* [`prometheus::exporter::snmp`](#prometheusexportersnmp): This module manages prometheus snmp_exporter
* [`prometheus::exporter::statsd`](#prometheusexporterstatsd): This module manages prometheus statsd_exporter
* [`prometheus::exporter::unbound`](#prometheusexporterunbound): This module manages prometheus unbound exporter. The exporter needs to be compiled by hand! (https://github.com/kumina/unbound_exporter/issues/21)
* [`prometheus::exporter::varnish`](#prometheusexportervarnish): This module manages prometheus varnish_exporter
...
### <a name="prometheusexporterapache"></a>`prometheus::exporter::apache`

This module manages prometheus apache_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::apache` class:
...
### <a name="prometheusexporterbeanstalkd"></a>`prometheus::exporter::beanstalkd`

This module manages prometheus beanstalkd_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::beanstalkd` class:
...
### <a name="prometheusexporterbind"></a>`prometheus::exporter::bind`

Class: prometheus::exporter::bind

This module manages prometheus bind_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::bind` class:
...
### <a name="prometheusexporterbird"></a>`prometheus::exporter::bird`
...
The following parameters are available in the `prometheus::exporter::bird` class:
...
### <a name="prometheusexporterblackbox"></a>`prometheus::exporter::blackbox`
...
The following parameters are available in the `prometheus::exporter::blackbox` class:
...
### <a name="prometheusexportercollectd"></a>`prometheus::exporter::collectd`

This module manages prometheus node collectd_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::collectd` class:
...
### <a name="prometheusexporterconsul"></a>`prometheus::exporter::consul`

This module manages prometheus node consul_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::consul` class:
...
### <a name="prometheusexporterdellhw"></a>`prometheus::exporter::dellhw`

This module manages prometheus node dellhw_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::dellhw` class:
...
### <a name="prometheusexporterelasticsearch"></a>`prometheus::exporter::elasticsearch`

This module manages prometheus elasticsearch_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::elasticsearch` class:
...
### <a name="prometheusexportergraphite"></a>`prometheus::exporter::graphite`

This module manages prometheus node graphite_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::graphite` class:
...
### <a name="prometheusexportergrok"></a>`prometheus::exporter::grok`

This module manages prometheus grok_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::grok` class:
...
### <a name="prometheusexporterhaproxy"></a>`prometheus::exporter::haproxy`

This module manages prometheus haproxy_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::haproxy` class:
...
### <a name="prometheusexportermemcached"></a>`prometheus::exporter::memcached`

This module manages prometheus node memcached_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::memcached` class:
...
### <a name="prometheusexportermesos"></a>`prometheus::exporter::mesos`

This module manages prometheus mesos_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::mesos` class:
...
### <a name="prometheusexportermongodb"></a>`prometheus::exporter::mongodb`

This module manages prometheus mongodb_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::mongodb` class:
...
### <a name="prometheusexportermysqld"></a>`prometheus::exporter::mysqld`
...
The following parameters are available in the `prometheus::exporter::mysqld` class:
...
### <a name="prometheusexporternginx_vts"></a>`prometheus::exporter::nginx_vts`

This module manages prometheus nginx_vts_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::nginx_vts` class:
...
### <a name="prometheusexporternode"></a>`prometheus::exporter::node`

This module manages prometheus node node_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::node` class:
...
### <a name="prometheusexporterpostfix"></a>`prometheus::exporter::postfix`
...
The following parameters are available in the `prometheus::exporter::postfix` class:
...
### <a name="prometheusexporterpostgres"></a>`prometheus::exporter::postgres`

This module manages prometheus node postgres_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::postgres` class:
...
### <a name="prometheusexporterprocess"></a>`prometheus::exporter::process`
...
```puppet
class { 'prometheus::exporter::process':
  version                => '0.6.0',
  arch                   => 'amd64',
  os                     => 'linux',
...
The following parameters are available in the `prometheus::exporter::process` class:
...
### <a name="prometheusexporterpuppetdb"></a>`prometheus::exporter::puppetdb`

This module manages prometheus node puppetdb_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::puppetdb` class:
...
### <a name="prometheusexporterrabbitmq"></a>`prometheus::exporter::rabbitmq`

This module manages prometheus rabbitmq_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::rabbitmq` class:
...
### <a name="prometheusexporterredis"></a>`prometheus::exporter::redis`

This module manages prometheus node redis_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::redis` class:
...
### <a name="prometheusexportersnmp"></a>`prometheus::exporter::snmp`

This module manages prometheus snmp_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::snmp` class:
...
### <a name="prometheusexporterstatsd"></a>`prometheus::exporter::statsd`

This module manages prometheus statsd_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::statsd` class:
...
### <a name="prometheusexporterunbound"></a>`prometheus::exporter::unbound`
...
The following parameters are available in the `prometheus::exporter::unbound` class:
...
### <a name="prometheusexportervarnish"></a>`prometheus::exporter::varnish`

This module manages prometheus varnish_exporter

#### Parameters

The following parameters are available in the `prometheus::exporter::varnish` class:
...
```puppet
Variant[Stdlib::HTTPUrl, Stdlib::HTTPSUrl, Prometheus::S3Uri, Prometheus::GsUri]
```
